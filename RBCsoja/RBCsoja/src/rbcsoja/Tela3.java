...
public class Tela3 extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        Integer aux1 = Dados.caso.length + 1;
             try {
            FileWriter writer = new FileWriter(arquivoCSV);
            writer.append(aux1.toString());
            writer.append(',');
            writer.append(Dados.areadamaged);
            writer.append(',');
            writer.append(Dados.canckerlesion);
            writer.append(',');
            writer.append(Dados.croohist);
            writer.append(',');
            writer.append(Dados.data);
            writer.append(',');
            writer.append(Dados.externaldecay);
            writer.append(',');
            writer.append(Dados.fruitspots);
            writer.append(',');
            writer.append(Dados.fruitingbodies);
            writer.append(',');
            writer.append(Dados.fruitpods);
            writer.append(',');
            writer.append(Dados.germination);
            writer.append(',');
            writer.append(Dados.hail);
            writer.append(',');
            writer.append(Dados.intdiscolor);
            writer.append(',');
            writer.append(Dados.leafmalf);
            writer.append(',');
            writer.append(Dados.leafmild);
            writer.append(',');
            writer.append(Dados.leafshred);
            writer.append(',');
            writer.append(Dados.leafspothalo);
            writer.append(',');
            writer.append(Dados.leafspotsize);
            writer.append(',');
            writer.append(Dados.leafsspotmarg);
            writer.append(',');
            writer.append(Dados.leaves);
            writer.append(',');
            writer.append(Dados.lodgi);
            writer.append(',');
            writer.append(Dados.moldgrowth);
            writer.append(',');
            writer.append(Dados.mycelium);
            writer.append(',');
            writer.append(Dados.plantgrowth);
            writer.append(',');
            writer.append(Dados.plantstand);
            writer.append(',');
            writer.append(Dados.precip);
            writer.append(',');
            writer.append(Dados.roots);
            writer.append(',');
            writer.append(Dados.sclerotia);
            writer.append(',');
            writer.append(Dados.seed);
            writer.append(',');
            writer.append(Dados.seeddis);
            writer.append(',');
            writer.append(Dados.seedsize);
            writer.append(',');
            writer.append(Dados.seedtmt);
            writer.append(',');
            writer.append(Dados.severity);
            writer.append(',');
            writer.append(Dados.shriveling);
            writer.append(',');
            writer.append(Dados.stem);
            writer.append(',');
            writer.append(Dados.stemcancker);
            writer.append(',');
            writer.append(Dados.temp);
            writer.append(',');
            writer.append(Dados.doenca[Dados.aux1]);
            writer.append('\n');
